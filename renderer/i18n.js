...
const TRANSLATIONS = {
  ru: {
    ...
    tabAudit: 'Аудит сайта',
    auditTitle: 'Аудит сайта',
    auditHint: 'Сбор данных Search Console и анализ через ваш OpenAI-compatible API-ключ.',
    selectSite: 'Выберите свойство',
    ...
    aiApiKeySavedPlaceholder: 'Сохранён (введите новый, чтобы заменить)',
    saveAiSettings: 'Сохранить настройки ИИ',
    clearAiKey: 'Удалить ключ',
    aiSettingsSaved: 'Настройки ИИ сохранены',
    aiKeyCleared: 'API-ключ удалён',
    clearAiKeyConfirm: 'Удалить сохранённый API-ключ ИИ с этого устройства?',
    runAudit: 'Запустить аудит',
    auditCollecting: 'Сбор данных Search Console...',
    auditAnalyzing: 'Анализ с помощью ИИ...',
    auditDone: 'Аудит завершён',
    auditBaselineTitle: 'Baseline (28 / 90 дней)',
    auditAnalysisTitle: 'Анализ ИИ',
    exportAuditMd: 'Экспорт Markdown',
    auditClicks28: 'Клики (28д)',
    auditImpressions28: 'Показы (28д)',
    auditCtr28: 'CTR (28д)',
    auditPosition28: 'Позиция (28д)',
    auditClicks90: 'Клики (90д)',
    auditImpressions90: 'Показы (90д)',
    selectSiteFirst: 'Выберите свойство Search Console',
    saveAiFirst: 'Сначала сохраните настройки ИИ с API-ключом',
  },
  en: {
    appTitle: 'Google Search Console Updater',
    ...
    tabAudit: 'Site audit',
    auditTitle: 'Site audit',
    auditHint: 'Collect Search Console data and analyze it with your OpenAI-compatible API key.',
    selectSite: 'Select a property',
    aiBaseUrl: 'AI base URL',
    aiModel: 'Model',
    aiApiKey: 'API key',
    aiBaseUrlPlaceholder: 'https://api.openai.com/v1',
    ...
    aiApiKeySavedPlaceholder: 'Saved (enter a new one to replace)',
    saveAiSettings: 'Save AI settings',
    clearAiKey: 'Clear key',
    aiSettingsSaved: 'AI settings saved',
    aiKeyCleared: 'API key cleared',
    clearAiKeyConfirm: 'Delete the saved AI API key from this device?',
    runAudit: 'Run audit',
    auditCollecting: 'Collecting Search Console data...',
    auditAnalyzing: 'Analyzing with AI...',
    auditDone: 'Audit complete',
    auditBaselineTitle: 'Baseline (28 / 90 days)',
    auditAnalysisTitle: 'AI analysis',
    exportAuditMd: 'Export Markdown',
    auditClicks28: 'Clicks (28d)',
    auditImpressions28: 'Impressions (28d)',
    auditCtr28: 'CTR (28d)',
    auditPosition28: 'Position (28d)',
    auditClicks90: 'Clicks (90d)',
    auditImpressions90: 'Impressions (90d)',
    selectSiteFirst: 'Select a Search Console property',
    saveAiFirst: 'Save AI settings with an API key first',
  },
};
